"""
Window opens fullscreen; press 'q' or ESC to quit.
"""
import cv2
import numpy as np
SQUARES_W  = 7
...
class CharucoBig:
    def __init__(self):
        ...
        self.board = cv2.aruco.CharucoBoard((SQUARES_W, SQUARES_H),SQUARE_MM/1000,MARKER_MM/1000,self.aruco_dict)
        ...
        board_img = self.board.generateImage((SQUARES_W*100, SQUARES_H*100))
